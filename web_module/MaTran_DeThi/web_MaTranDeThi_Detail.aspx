<%@ Page Language="C#" AutoEventWireup="true" CodeFile="web_MaTranDeThi_Detail.aspx.cs" Inherits="web_module_web_MaTranDeThi_Detail" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table border="1" class="format" style="margin: auto; text-align: center">
                ...
                <asp:Repeater ID="rpDetail0" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td>1</td>
                            ...
                            <td><%#Eval("count_NB_TN") %> câu<br />
                                (<%#Eval("point_NB_TN") %>đ)<br />
                                <%#Eval("percent_NB_TN") %>%</td>
                            <td><%#Eval("count_NB_TL") %> câu<br />
                                (<%#Eval("point_NB_TL") %>đ)<br />
                                <%#Eval("percent_NB_TL") %>%</td>
                            <td><%#Eval("count_TH_TN") %> câu<br />
                                (<%#Eval("point_TH_TN") %>đ)<br />
                                <%#Eval("percent_TH_TN") %>%</td>
                            <td><%#Eval("count_TH_TL") %> câu<br />
                                (<%#Eval("point_TH_TL") %>đ)<br />
                                <%#Eval("percent_TH_TL") %>%</td>
                            <td><%#Eval("count_VD_TN") %> câu<br />
                                (<%#Eval("point_VD_TN") %>đ)<br />
                                <%#Eval("percent_VD_TN") %>%</td>
                            <td><%#Eval("count_VD_TL") %> câu<br />
                                (<%#Eval("point_VD_TL") %>đ)<br />
                                <%#Eval("percent_VD_TL") %>%</td>
                            <td><%#Eval("count_VDC_TN") %> câu<br />
                                (<%#Eval("point_VDC_TN") %>đ)<br />
                                <%#Eval("percent_VDC_TN") %>%</td>
                            <td><%#Eval("count_VDC_TL") %> câu<br />
                                (<%#Eval("point_VDC_TL") %>đ)<br />
                                <%#Eval("percent_VDC_TL") %>%</td>
                            <td><%#Eval("sum_count_lesson") %><br />
                                <%#Eval("sum_point_lesson") %>đ<br />
                                <%#Eval("sum_percent_lesson") %>%</td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
                <tr>
