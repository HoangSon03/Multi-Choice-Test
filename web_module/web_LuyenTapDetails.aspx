<%@ Page Language="C#" AutoEventWireup="true" CodeFile="web_LuyenTapDetails.aspx.cs" Inherits="web_module_web_LuyenTapDetails" %>
                        ...
                        <div class="container">
                            ...
                            <div id="div_NhacNho" runat="server">
                              ...
                              <%--  <button id="btnTriggerTime" onclick="countDown()">Làm bài</button>--%>
                                ...
                                <div id="div_LinkVideo" runat="server" style="text-align: center">
                                    <asp:Repeater ID="rpLinkVideo" runat="server">
                                        <ItemTemplate>
                                            <iframe width="560" height="315" src="<%#Eval("luyentap_linkvideo") %>" frameborder="0" allowfullscreen></iframe>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
