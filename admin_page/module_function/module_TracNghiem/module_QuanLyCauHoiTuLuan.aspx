                        ...
                        <ContentTemplate>
                            ...
                            <div class="row question">
                                ...
                                <div class="col-sm-4 question_radio">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlLoaiCauHoi">
                                ...
                                <div class="col-sm-4 question_radio">
                                    <h2 class="title_h2">mức độ câu hỏi:</h2>
                        ...
                        <ContentTemplate>
                            <div class="col-sm-6">
                                <div id="dvnoidungcauhoi">
                                    ...
                                    <dx:ASPxHtmlEditor ID="edtContent" ClientInstanceName="edtContent" runat="server" Width="100%" Height="150px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
                            ...
                            <div class="col-sm-6">
                                <div class="col-sm-12 marginFooter">
                                    <h2 class="title_h2_c title_h2_c-active">Giải thích cho câu trả lời đúng:</h2>
                                    <dx:ASPxHtmlEditor ID="edtGiaiThich" ClientInstanceName="edtGiaiThich" runat="server" Width="100%" Height="210px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
                                        <SettingsHtmlEditing EnablePasteOptions="true" />
                                        <Settings AllowHtmlView="true" AllowContextMenu="Default" />
                                        <settingsimageupload uploadfolder="~/editorimages"></settingsimageupload>
                                        <Toolbars>
                            ...
                            <div class="col-sm-6">
                                <div class="col-sm-12 marginFooter">
                                    <h2 class="title_h2_c title_h2_c-active">Đặc tả câu hỏi :</h2>
                                    <dx:ASPxHtmlEditor ID="edtDacta" ClientInstanceName="edtDacta" runat="server" Width="100%" Height="210px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
                                        <SettingsHtmlEditing EnablePasteOptions="true" />
                                        <Settings AllowHtmlView="true" AllowContextMenu="Default" />
                                        <settingsimageupload uploadfolder="~/editorimages"></settingsimageupload>
                                        <Toolbars>
