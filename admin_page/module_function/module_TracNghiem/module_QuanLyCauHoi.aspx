<%@ Page Language="C#" AutoEventWireup="true" CodeFile="module_QuanLyCauHoi.aspx.cs" Inherits="admin_page_module_function_module_TracNghiem_Test" %>
                ...
                <div class="col-sm-12">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-sm-12 question_radio" id="DangCauHoi_">
                    ...
                    <input type="checkbox" id="DaD" runat="server" /></h2>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-12 marginFooter">
                                    <h2 class="title_h2_c title_h2_c-active">Giải thích cho câu trả lời đúng:
                                    </h2>
