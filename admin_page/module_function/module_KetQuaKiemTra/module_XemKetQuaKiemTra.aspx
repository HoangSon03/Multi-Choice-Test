<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_XemKetQuaKiemTra.aspx.cs" Inherits="admin_page_module_function_module_KetQuaKiemTra_module_XemKetQuaKiemTra" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <div class="main-omt">
        <div class="omt-header">
            ...
            <h4 class="header-title">Kết quả kiểm tra của học sinh</h4>
        </div>
        <div class="omt-top">
